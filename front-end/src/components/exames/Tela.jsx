...
import { BsSearch, BsXCircle, BsClipboardPlusFill } from "react-icons/bs";
...
function TelaExames() {
    ...
    const handleBuscar = async () => {
        ...
        try {
            const dados = filtro
                ? await ExameService.filtrar(filtro)
                : await ExameService.listarTodos();
            setExames(dados);
        } catch (error) {
            setExames([]);
        } finally {
