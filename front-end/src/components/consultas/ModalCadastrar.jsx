...
function ModalCadastrarConsulta({ show, onHide, Cadastro }) {
    ...
    const handleClose = () => {
        ...
        setCpfBusca('');
        setForm({
            con_paciente_id: '', con_medico_id: '', con_data: '',
            con_hora: '', con_tipo: '', con_status: 'agendada', con_observacoes: ''
        });
        onHide();
    };
            ...
            <Form onSubmit={handleSubmit} noValidate>
                ...
                <Modal.Body>
                    ...
                    <div className="p-3 mb-3 rounded" style={{ background: '#f8f9fa', border: '1px solid #dee2e6' }}>
                        ...
                        {erros.con_paciente_id && (
                            <div className="text-danger small mt-1">{erros.con_paciente_id}</div>
                        )}
                        {paciente && (
